(function() {
      ...
      a &&
        (c
          ? (
              ...
              b && f.test(b) && (d = ' id="' + b + '"'),
              f.test(a) &&
                M.write("<script" + d + ' src="' + a + '">\x3c/script>')
            )
          : (
  ...
  var Ca = function(a) {
    ...
    zc = function(a, b, c, d, e, g) {
      e = G(e)
        ? !1
        : eb.test(M.location.hostname) || ("/" == c && vc.test(d)) ? !1 : !0;
      if (!e) return !1;
  ...
  var Fa,
    ...
    Pc = function(a) {
      ...
      var b = O.XMLHttpRequest;
      if (!b) return J(59), !1;
      var c = new b();
      if (!("withCredentials" in c)) return J(60), !1;
      c.open(
        "POST",
        ...
        if (4 == c.readyState) {
          try {
            ...
            a.optOut
              ...
              : a.clientId
                ? Qc(a.clientId, a.securityToken, 31536e6)
  ...
  var oc = function() {
    ...
    x = function(a, b, c) {
      return O.navigator.sendBeacon
        ? O.navigator.sendBeacon(a, b) ? (c(), !0) : !1
        : !1;
    },
    ge = function(a, b, c) {
      1 <= 100 * Math.random() ||
  ...
  function fc() {
    ...
    if (!a)
      try {
        (e = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6")), (a =
          "WIN 6,0,21,0"), (e.AllowScriptAccess = "always"), (a = e.GetVariable(
          "$version"
        ));
      } catch (g) {}
    if (!a)
  ...
  var Jd = function(a, b, c) {
      ...
      (b = c) ||
        (b =
          (b = P(a, V)) && "t0" != b
            ? Wd.test(b) ? "_gat_" + Cc(P(a, Na)) : "_gat_" + Cc(b)
            : "_gat");
      this.Y = b;
    },
    Rd = function(a, b) {
    ...
    bd = function(a, b, c) {
      if (!ad) {
        ...
        if (
          ...
          zc("GASO", "" + d, c, b, a, 0), window._udo ||
            (window._udo = b), window._utcp || (window._utcp = c), (a =
            e[1]), wa(
  ...
  var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
    ...
    Jc = function(a, b) {
      ...
      if (a.get(Hd))
        a: if (
          ((c = a.get(cc)), (d = E(M.location[c ? "href" : "search"], "_ga")))
        )
          if (a.get(bc))
  ...
  Z.J = function(a) {
    for (var b, c = [], d = 0; d < arguments.length; d++)
      try {
        (b = new sc(arguments[d])), b.g
          ? C(b.a[0], b.a[1])
          : (b.i && (b.ha = y(b.c, b.a[0], b.X, b.W)), c.push(b));
      } catch (e) {}
    return c;
  };
  Z.v = function(a) {
