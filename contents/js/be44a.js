...
!(function(a, b) {
  ...
  (n.fn = n.prototype = {
    ...
    for (
      "boolean" == typeof g &&
        ((j = g), (g = arguments[h] || {}), h++), "object" == typeof g ||
        n.isFunction(g) ||
        (g = {}), h === i && ((g = this), h--);
      i > h;
      h++
  ...
  var t = (function(a) {
    ...
    try {
      H.apply((E = I.call(v.childNodes)), v.childNodes), E[v.childNodes.length]
        .nodeType;
    } catch (ea) {
      H = {
        apply: E.length
      ...
      if (
        ...
        if (c.qsa && !A[a + " "] && (!q || !q.test(a))) {
          if (1 !== x) (w = b), (s = a);
            ...
            (k = b.getAttribute("id"))
              ? (k = k.replace(aa, "\\$&"))
              : b.setAttribute("id", (k = u)), (r = g(a)), (h =
              r.length), (l = V.test(k) ? "#" + k : "[id='" + k + "']");
    ...
    (c = fa.support = {}), (f = fa.isXML = function(a) {
              ...
              (
                ia(function(a) {
                  (o.appendChild(a).innerHTML =
                    ...
                    "'></a><select id='" +
                    u +
                    "-\r\\' msallowcapture=''><option selected=''></option></select>"), a.querySelectorAll("[msallowcapture^='']").length && q.push("[*^$]=" + L + "*(?:''|\"\")"), a.querySelectorAll("[selected]").length || q.push("\\[" + L + "*(?:value|" + K + ")"), a.querySelectorAll("[id~=" + u + "-]").length || q.push("~="), a.querySelectorAll(":checked").length || q.push(":checked"), a.querySelectorAll("a#" + u + "+*").length || q.push(".#.+[+~]");
                }),
                ia(function(a) {
      ...
      preFilter: {
        ATTR: function(a) {
          return (a[1] = a[1].replace(ba, ca)), (a[3] = (a[3] ||
            a[4] ||
            a[5] ||
            "")
            .replace(ba, ca)), "~=" === a[2] &&
            ...
            : function(b, c, i) {
                ...
                if (q) {
                  ...
                  if (((o = [g ? q.firstChild : q.lastChild]), g && s)) {
                    (m = q), (l = m[u] || (m[u] = {})), (k =
                      l[m.uniqueID] || (l[m.uniqueID] = {})), (j =
                      k[a] || []), (n = j[0] === w && j[1]), (t =
                      n && j[2]), (m = n && q.childNodes[n]);
      ...
      pseudos: {
        ...
        lang: ha(function(a) {
          return V.test(a || "") ||
            fa.error(
              "unsupported lang: " + a
            ), (a = a.replace(ba, ca).toLowerCase()), function(b) {
            var c;
            do
              if (
                (c = p
    ...
    function pa() {}
    (pa.prototype = d.filters =
      d.pseudos), (d.setFilters = new pa()), (g = fa.tokenize = function(a, b) {
      var c,
        e,
        f,
        g,
    ...
    function va(a, b, c, d, e, f) {
      return d && !d[u] && (d = va(d)), e &&
        !e[u] &&
        (e = va(e, f)), ha(function(f, g, h, i) {
        var j,
          k,
          l,
          m = [],
    ...
    return (h = fa.compile = function(a, b) {
      ...
      u.split("").sort(B).join("") ===
      u), (c.detectDuplicates = !!l), m(), (c.sortDetached = ia(function(a) {
  ...
  (n.filter = function(a, b, c) {
    ...
    find: function(a) {
      ...
      return (c = this.pushStack(e > 1 ? n.unique(c) : c)), (c.selector = this
        .selector
        ? this.selector + " " + a
        : a), c;
    },
  ...
  var A,
    ...
    C = (n.fn.init = function(a, b, c) {
      ...
      return a.nodeType
        ...
        : n.isFunction(a)
          ? "undefined" != typeof c.ready ? c.ready(a) : a(n)
          : (
              void 0 !== a.selector &&
    ...
    when: function(a) {
      var b = 0,
        ...
        h = function(a, b, c) {
          return function(d) {
            (b[a] = this), (c[a] =
              arguments.length > 1 ? e.call(arguments) : d), c === i
              ? g.notifyWith(b, c)
              : --f || g.resolveWith(b, c);
          };
        },
  ...
  (n.ready.promise = function(b) {
    if (!I)
      if (
        ...
        d.addEventListener("DOMContentLoaded", K), a.addEventListener(
          "load",
          K
        );
      else {
  ...
  function R(a, b, d, e) {
    if (M(a)) {
      ...
      if (
        ...
        return k || (k = i ? (a[h] = c.pop() || n.guid++) : h), j[k] ||
          (j[k] = i ? {} : { toJSON: n.noop }), ("object" != typeof b &&
          "function" != typeof b) ||
          (e
            ? (j[k] = n.extend(j[k], b))
            : (j[k].data = n.extend(j[k].data, b))), (g = j[k]), e ||
          (g.data || (g.data = {}), (g = g.data)), void 0 !== d &&
          (g[n.camelCase(b)] = d), "string" == typeof b
      ...
      if (g[h]) {
        if (b && (d = c ? g[h] : g[h].data)) {
          n.isArray(b)
            ...
            : b in d
              ? (b = [b])
              : ((b = n.camelCase(b)), (b = b in d ? [b] : b.split(" "))), (e =
            b.length);
        ...
        (c || (delete g[h].data, Q(g[h]))) &&
          (f
            ? n.cleanData([a], !0)
            : l.deleteExpando || g != g.window ? delete g[h] : (g[h] = void 0));
      }
    }
  }
  n.extend({
    ...
    hasData: function(a) {
      return (a = a.nodeType ? n.cache[a[n.expando]] : a[n.expando]), !!a &&
        !Q(a);
    },
    data: function(a, b, c) {
      return R(a, b, c);
    ...
    l.shrinkWrapBlocks = function() {
      ...
      a = !1;
      var b, c, e;
      return (c = d.getElementsByTagName("body")[0]), c && c.style
        ? (
  ...
  (da.optgroup =
    da.option), (da.tbody = da.tfoot = da.colgroup = da.caption = da.thead), (da.th = da.td);
  function ea(a, b) {
    var c,
      d,
      e = 0,
  ...
  function ja(a, b, c, d, e) {
      ...
      if (((g = a[r]), g || 0 === g))
        if ("object" === n.type(g)) n.merge(q, g.nodeType ? [g] : g);
          ...
          (i = i || p.appendChild(b.createElement("div"))), (j = ($.exec(g) || [
            ...
            .toLowerCase()), (m = da[j] || da._default), (i.innerHTML =
            m[1] + n.htmlPrefilter(g) + m[2]), (f = m[0]);
          ...
          if (
            ...
            (g =
              "table" !== j || ha.test(g)
                ? "<table>" !== m[1] || ha.test(g) ? 0 : i
                : i.firstChild), (f = g && g.childNodes.length);
            while (f--)
    ...
    i &&
      p.removeChild(i), l.appendChecked || n.grep(ea(q, "input"), ia), (r = 0);
    while ((g = q[r++]))
  ...
  (n.event = {
    ...
    add: function(a, b, c, d, e) {
      ...
      if (r) {
        c.handler && ((i = c), (c = i.handler), (e = i.selector)), c.guid ||
          (c.guid = n.guid++), (g = r.events) || (g = r.events = {}), (k =
          r.handle) ||
          (
            ...
            (k.elem = a)
          ), (b = (b || "").match(G) || [""]), (h = b.length);
        while (h--)
          (f = oa.exec(b[h]) || []), (o = q = f[1]), (p = (f[2] || "")
            .split(".")
            .sort()), o &&
            (
              (j = n.event.special[o] || {}),
      ...
      if (r && (k = r.events)) {
        ...
        while (j--)
          if (
            ...
            (l = n.event.special[o] || {}), (o =
              (d ? l.delegateType : l.bindType) || o), (m = k[o] || []), (h =
              h[2] &&
              new RegExp(
                "(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"
              )), (i = f = m.length);
            while (f--)
              (g = m[f]), (!e && q !== g.origType) ||
                (c && c.guid !== g.guid) ||
    ...
    trigger: function(b, c, e, f) {
      ...
      if (
        ...
        while ((i = p[o++]) && !b.isPropagationStopped())
          (b.type = o > 1 ? j : l.bindType || q), (g =
            (n._data(i, "events") || {})[b.type] && n._data(i, "handle")), g &&
            g.apply(i, c), (g = h && i[h]), g &&
            g.apply &&
            M(i) &&
          ...
          while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped())
            (a.rnamespace && !a.rnamespace.test(g.namespace)) ||
              (
                (a.handleObj = g),
                (a.data = g.data),
                (d = ((n.event.special[g.origType] || {}).handle || g.handler)
                  .apply(f.elem, i)),
                void 0 !== d &&
                  (a.result = d) === !1 &&
    ...
    fix: function(a) {
      ...
      h ||
        (this.fixHooks[f] = h = ma.test(f)
          ? this.mouseHooks
          : la.test(f) ? this.keyHooks : {}), (e = h.props
        ? this.props.concat(h.props)
        : this.props), (a = new n.Event(g)), (b = e.length);
      while (b--) (c = e[b]), (a[c] = g[c]);
      return a.target || (a.target = g.srcElement || d), 3 ===
        a.target.nodeType &&
    ...
    mouseHooks: {
      ...
      filter: function(a, b) {
        ...
        return null == a.pageX &&
          ...
          h &&
          (a.relatedTarget = h === a.target ? b.toElement : h), a.which ||
          void 0 === g ||
    ...
    preventDefault: function() {
      ...
      (this.isDefaultPrevented = pa), a &&
        (a.preventDefault ? a.preventDefault() : (a.returnValue = !1));
    },
    stopPropagation: function() {
      var a = this.originalEvent;
      (this.isPropagationStopped = pa), a &&
        !this.isSimulated &&
        (a.stopPropagation && a.stopPropagation(), (a.cancelBubble = !0));
    },
    stopImmediatePropagation: function() {
      var a = this.originalEvent;
      (this.isImmediatePropagationStopped = pa), a &&
              ...
              ("checkbox" !== this.type && "radio" !== this.type) ||
                (
                  ...
                  n.event.add(this, "click._change", function(a) {
                    this._justChanged &&
                      !a.isTrigger &&
                      (this._justChanged = !1), n.event.simulate("change", this, a);
                  })
                ),
              !1
            )
  ...
  function Ha(a, b, c, d) {
    ...
    if (
      ...
      for (i = n.map(ea(k, "script"), Da), h = i.length; o > m; m++)
        (g = k), m !== p &&
          ((g = n.clone(g, !0, !0)), h && n.merge(i, ea(g, "script"))), c.call(
          a[m],
          g,
          m
        );
        ...
        for (j = i[i.length - 1].ownerDocument, n.map(i, Ea), m = 0; h > m; m++)
          (g = i[m]), _.test(g.type || "") &&
            ...
            (g.src
              ...
              : n.globalEval(
                  (g.text || g.textContent || g.innerHTML || "").replace(za, "")
                ));
      k = e = null;
    }
    return a;
  ...
  function Ia(a, b, c) {
    for (var d, e = b ? n.filter(b, a) : a, f = 0; null != (d = e[f]); f++)
      c || 1 !== d.nodeType || n.cleanData(ea(d)), d.parentNode &&
        (
  ...
  n.extend({
    ...
    clone: function(a, b, c) {
      ...
      return (d = ea(f, "script")), d.length > 0 &&
        fa(d, !i && ea(a, "script")), (d = h = e = null), f;
    },
    ...
    function(a, b) {
      n.fn[a] = function(a) {
        for (var c, d = 0, e = [], f = n(a), h = f.length - 1; h >= d; d++)
          (c = d === h ? this : this.clone(!0)), n(f[d])[b](c), g.apply(
            e,
            c.get()
          );
  ...
  function Ma(a) {
    ...
    return c ||
      (
        ...
        ("none" !== c && c) ||
          (
            (Ja = (Ja || n("<iframe frameborder='0' width='0' height='0'/>"))
  ...
  !(function() {
    ...
    if (j.style) {
      (j.style.cssText = "float:left;opacity:.5"), (l.opacity =
        "0.5" === j.style.opacity), (l.cssFloat = !!j.style
        .cssFloat), (j.style.backgroundClip = "content-box"), (j.cloneNode(
        !0
      ).style.backgroundClip =
        ""), (l.clearCloneStyle =
        "content-box" === j.style.backgroundClip), (i = d.createElement(
        "div"
      )), (i.style.cssText =
        "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute"), (j.innerHTML =
        ""), i.appendChild(j), (l.boxSizing =
        "" === j.style.boxSizing ||
      ...
      function k() {
        ...
        m.appendChild(i), (j.style.cssText =
          "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%"), (b = e = h = !1), (c = g = !0), a.getComputedStyle &&
          (
            ...
            j.removeChild(k)
          ), (j.style.display = "none"), (f =
          0 === j.getClientRects().length), f &&
          (
            (j.style.display = ""),
      ...
      (
        ...
        (Sa = function(a, b, c) {
          var d,
            ...
            g,
            h = a.style;
          return (c = c || Ra(a)), (g = c ? c[b] : void 0), null == g &&
            h &&
            h[b] &&
            (g = h[b]), Oa.test(g) &&
            !Ta.test(b) &&
  ...
  function eb(a, b, c, d, e) {
    for (
      ...
      "margin" === c && (g += n.css(a, c + V[f], !0, e)), d
        ? (
  ...
  function fb(a, b, c) {
    ...
    if (0 >= e || null == e) {
      if (
        ...
        return e;
      (d = g && (l.boxSizingReliable() || e === a.style[b])), (e =
        parseFloat(e) || 0);
    }
  ...
  n.extend({
    ...
    css: function(a, b, c, d) {
      var e,
        ...
        g,
        h = n.camelCase(b);
      return (b = n.cssProps[h] || (n.cssProps[h] = bb(h) || h)), (g =
        n.cssHooks[b] || n.cssHooks[h]), g &&
        "get" in g &&
        (f = g.get(a, !0, c)), void 0 === f && (f = Sa(a, b, d)), "normal" ===
        f &&
        b in $a &&
        (f = $a[b]), "" === c || c
  ...
  (n.Tween = gb), (gb.prototype = {
    ...
    run: function(a) {
      ...
      return this.options.duration
        ...
        ? c.set(this)
        : gb.propHooks._default.set(this), this;
    }
  ...
  function ob(a, b, c) {
    ...
    if (n.isEmptyObject(o))
      ...
      r ? "hidden" in r && (q = r.hidden) : (r = n._data(a, "fxshow", {})), f &&
        (r.hidden = !q), q
        ? n(a).show()
        : m.done(function() {
            n(a).hide();
  ...
  function qb(a, b, c) {
    ...
    for (pb(k, j.opts.specialEasing); g > f; f++)
      if ((d = qb.prefilters[f].call(j, a, k, j.opts)))
        return n.isFunction(d.stop) &&
          (n._queueHooks(j.elem, j.opts.queue).stop = n.proxy(d.stop, d)), d;
    return n.map(
      k,
      nb,
      j
  ...
  (n.Animation = n.extend(qb, {
    ...
    tweener: function(a, b) {
      ...
      for (var c, d = 0, e = a.length; e > d; d++)
        (c = a[d]), (qb.tweeners[c] = qb.tweeners[c] || []), qb.tweeners[
          c
        ].unshift(b);
    },
    prefilters: [ob],
    ...
    return (b = n.fx ? n.fx.speeds[b] || b : b), (c =
    ...
    (c = d.createElement(
      "div"
    )), c.setAttribute("className", "t"), (c.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"), (a = c.getElementsByTagName("a")[0]), b.setAttribute("type", "checkbox"), c.appendChild(b), (a = c.getElementsByTagName("a")[0]), (a.style.cssText = "top:1px"), (l.getSetAttribute = "t" !== c.className), (l.style = /top/.test(a.getAttribute("style"))), (l.hrefNormalized = "/a" === a.getAttribute("href")), (l.checkOn = !!b.value), (l.optSelected = f.selected), (l.enctype = !!d.createElement("form").enctype), (e.disabled = !0), (l.optDisabled = !f.disabled), (b = d.createElement("input")), b.setAttribute("value", ""), (l.input = "" === b.getAttribute("value")), (b.value = "t"), b.setAttribute("type", "radio"), (l.radioValue = "t" === b.value);
  })();
  var rb = /\r/g,
    sb = /[\x20\t\r\n\f]+/g;
  n.fn.extend({
    val: function(a) {
        ...
        e = this[0];
      {
        ...
        if (e)
          return (b =
            n.valHooks[e.type] || n.valHooks[e.nodeName.toLowerCase()]), b &&
          "get" in b &&
  ...
  n.fn.extend({
      ...
      if (f && 1 === a.nodeType)
        while ((c = f[e++]))
          (d = n.propFix[c] || c), n.expr.match.bool.test(c)
            ...
            : n.attr(a, c, ""), a.removeAttribute(xb ? c : d);
    }
  }), (ub = {
    set: function(a, b, c) {
      return b === !1
        ...
        : (yb && xb) || !wb.test(c)
          ...
          : (a[n.camelCase("default-" + c)] = a[c] = !0), c;
    }
    ...
    (yb && xb) || !wb.test(b)
      ...
      : (vb[b] = function(a, b, c) {
          return c
            ? void 0
            : a[n.camelCase("default-" + b)] ? b.toLowerCase() : null;
        });
  }), (yb && xb) ||
    (n.attrHooks.value = {
      set: function(a, b, c) {
    ...
    (
      (tb = {
        set: function(a, b, c) {
          ...
          return d ||
            ...
            ), (d.value = b += ""), "value" === c || b === a.getAttribute(c)
            ? b
            : void 0;
        }
      }),
      (vb.id = vb.name = vb.coords = function(a, b, c) {
        ...
        return c
          ? void 0
          : (d = a.getAttributeNode(b)) && "" !== d.value ? d.value : null;
      }),
      (n.valHooks.button = {
        get: function(a, b) {
  ...
  n.fn.extend({
    ...
    propHooks: {
      tabIndex: {
        get: function(a) {
          ...
          return b
            ? parseInt(b, 10)
            : zb.test(a.nodeName) || (Ab.test(a.nodeName) && a.href) ? 0 : -1;
        }
      }
    },
    ...
    (n.propHooks.selected = {
      get: function(a) {
        var b = a.parentNode;
        return b &&
          (b.selectedIndex, b.parentNode && b.parentNode.selectedIndex), null;
      },
      set: function(a) {
        var b = a.parentNode;
  ...
  n.extend({
    ...
    ajax: function(b, c) {
      ...
      if (
        ...
        return w;
      (i = n.event && l.global), i &&
        0 === n.active++ &&
        n.event.trigger(
          "ajaxStart"
        ), (l.type = l.type.toUpperCase()), (l.hasContent = !Lb.test(
        l.type
      )), (f = l.url), l.hasContent ||
        (
          l.data &&
        ...
        c.contentType) &&
        w.setRequestHeader("Content-Type", l.contentType), w.setRequestHeader(
        "Accept",
    ...
    wrapAll: function(a) {
      ...
      if (this[0]) {
        ...
        this[0].parentNode && b.insertBefore(this[0]), b
          .map(function() {
            var a = this;
  ...
  a.attachEvent &&
    ...
    }), (l.cors = !!gc && "withCredentials" in gc), (gc = l.ajax = !!gc), gc &&
      ...
      if (!b.crossDomain || l.cors) {
        ...
        return {
          send: function(d, e) {
            ...
            b.mimeType &&
              g.overrideMimeType &&
              g.overrideMimeType(b.mimeType), b.crossDomain ||
              d["X-Requested-With"] ||
            ...
            g.send((b.hasContent && b.data) || null), (c = function(a, d) {
              ...
              if (c && (d || 4 === g.readyState))
                if (
                  ...
                  (j = {}), (f = g.status), "string" == typeof g.responseText &&
  ...
  n.ajaxSetup({
    ...
    void 0 === a.cache &&
      (a.cache = !1), a.crossDomain && ((a.type = "GET"), (a.global = !1));
      ...
      return {
        send: function(e, f) {
          (b = d.createElement("script")), (b.async = !0), a.scriptCharset &&
            (b.charset = a.scriptCharset), (b.src =
            a.url), (b.onload = b.onreadystatechange = function(a, c) {
      ...
      ? (
          ...
          d.always(function() {
            void 0 === f
              ...
              : (a[
                  e
                ] = f), b[e] && ((b.jsonpCallback = c.jsonpCallback), jc.push(e)), g && n.isFunction(f) && f(g[0]), (g = f = void 0);
          }),
          "script"
        )
      : void 0;
  ...
  (n.fn.load = function(a, b, c) {
    ...
    var d,
      ...
      h = a.indexOf(" ");
    return h > -1 &&
      ((d = n.trim(a.slice(h, a.length))), (a = a.slice(0, h))), n.isFunction(b)
      ? ((c = b), (b = void 0))
  ...
  function mc(a) {
    return n.isWindow(a)
      ? a
      : 9 === a.nodeType ? a.defaultView || a.parentWindow : !1;
  }
  (n.offset = {
    setOffset: function(a, b, c) {
      ...
      "static" === k &&
        ...
        ("absolute" === k || "fixed" === k) &&
        n.inArray("auto", [f, i]) > -1), j
        ? ((d = l.position()), (g = d.top), (e = d.left))
        : ((g = parseFloat(f) || 0), (e = parseFloat(i) || 0)), n.isFunction(
        b
      ) && (b = b.call(a, c, n.extend({}, h))), null != b.top &&
    ...
    offset: function(a) {
      ...
      var b,
        ...
        f = e && e.ownerDocument;
      if (f)
        return (b = f.documentElement), n.contains(b, e)
          ? (
...
"undefined" == typeof jQuery.migrateMute &&
  (jQuery.migrateMute = !0), (function(a, b, c) {
  function d(c) {
    var d = b.console;
    f[c] ||
      (
  ...
  (a.migrateWarnings = []), b.console &&
    ...
    (a.migrateTrace = !0), (a.migrateReset = function() {
  ...
  e(a, "attrFn", g || {}, "jQuery.attrFn is deprecated"), (a.attr = function(
    b,
    e,
    f,
    i
      ...
      try {
        ...
        try {
          document.querySelector(a), d(
            "Attribute selector with '#' must be quoted: " + b[0]
          ), (b[0] = a);
        } catch (e) {
  ...
  (a.parseJSON = function(a) {
    ...
    "CSS1Compat" === document.compatMode), e(
    a,
    "boxModel",
    a.boxModel,
    ...
    a.extend(
      ...
      b,
      this
    ), (b.superclass = this), (b.fn = b.prototype = this()), (b.fn.constructor = b), (b.sub = this.sub), (b.fn.init = function(
      d,
      e
    ) {
    ...
    return d("jQuery.fn.size() is deprecated; use the .length property"), this
      .length;
  });
  var y = !1;
  a.swap &&
  ...
  a.fn.data = function(b) {
    ...
    "events" !== b ||
    1 !== arguments.length ||
    ((e = a.data(g, b)), (f = a._data(g, b)), (e !== c && e !== f) || f === c)
  ...
  a.clean ||
    (a.clean = function(b, c, e, f) {
      (c = c || document), (c = (!c.nodeType && c[0]) || c), (c =
        c.ownerDocument || c), d("jQuery.clean() is deprecated");
      var g,
        h,
        i,
        j,
  ...
  a.event.props &&
    ...
    a !== document &&
      J.test(b) &&
      d("AJAX events should be attached to document: " + b), B.call(
      this,
      a,
      L(b || ""),
      c,
    ...
    var e = arguments,
      ...
      h = function(c) {
        ...
        return a._data(
          ...
          "lastToggle" + b.guid,
          d + 1
        ), c.preventDefault(), e[d].apply(this, arguments) || !1;
      };
    for (h.guid = f; g < e.length; ) e[g++].guid = f;
    return this.click(h);
  }), (a.fn.live = function(b, c, e) {
    return d("jQuery.fn.live() is deprecated"), F
      ? F.apply(this, arguments)
      : (a(this.context).on(b, this.selector, c, e), this);
  }), (a.fn.die = function(b, c) {
    return d("jQuery.fn.die() is deprecated"), G
      ? G.apply(this, arguments)
      : (a(this.context).off(b, this.selector || "**", c), this);
  }), (a.event.trigger = function(a, b, c, e) {
    return c ||
      J.test(a) ||
      d("Global events are undocumented and deprecated"), D.call(
      this,
      a,
      b,
      c || document,
    ...
    a.event.special[c] = {
      ...
      teardown: function() {
        return this !== document &&
          a.event.remove(document, c + "." + a._data(this, c)), !1;
      }
    };
  ...
  if (
    ...
    a.Deferred = function(b) {
      ...
      return (c.pipe = e.pipe = function() {
        var b = arguments;
        return d("deferred.pipe() is deprecated"), a
          .Deferred(function(d) {
