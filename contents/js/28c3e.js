              ...
              var r = this.value.trim(),
                i =
                  ("radio" !== this.getAttribute("type") &&
                    "checked" !== this.getAttribute("type")) ||
                  this.checked,
          ...
          function o() {
            ...
            [].forEach.call(t, function(t) {
              var r = !!t.getAttribute("data-show-if"),
                o = r
                  ? t.getAttribute("data-show-if").split(":")
                  : t.getAttribute("data-hide-if").split(":"),
                s = o[0],
                a = o[1] || "";
              if (n === s.toLowerCase()) {
                i(t, a, r).call(e);
            ...
            (
              ...
              a(document.body).on("submit", ".mc4wp-form", function(e) {
                ...
                c.trigger("submit", [
                  t,
                  e
                ]), c.trigger(t.id + ".submit", [t, e]);
              }),
              a(document.body).on("focus", ".mc4wp-form", function(e) {
                var t = c.getByElement(e.target || e.srcElement);
                t.started ||
                  (
                    c.trigger("started", [t, e]),
                    c.trigger(t.id + ".started", [t, e]),
                    (t.started = !0)
                  );
              }),
              a(document.body).on("change", ".mc4wp-form", function(e) {
                ...
                c.trigger("change", [
                  t,
                  e
                ]), c.trigger(t.id + ".change", [t, e]);
              }),
              s.listeners
            )
          ) {
            for (var f = s.listeners, l = 0; l < f.length; l++)
              c.on(f[l].event, f[l].callback);
            delete s.listeners;
          }
          if (((s.forms = c), u.submitted_form)) {
            ...
            !(function(e, t, n, i) {
              var o = document.body.clientHeight,
                s = Date.now();
              n && e.setData(i), u.auto_scroll &&
                r(e), window.addEventListener("load", function() {
                var a = Date.now() - s;
                u.auto_scroll &&
                  a < 800 &&
                  document.body.clientHeight != o &&
                  r(
                    e
                  ), c.trigger("submitted", [e]), c.trigger(e.id + ".submitted", [e]), n ? (c.trigger("error", [e, n]), c.trigger(e.id + ".error", [e, n])) : (c.trigger("success", [e, i]), c.trigger(e.id + ",success", [e, i]), c.trigger(t + "d", [e, i]), c.trigger(e.id + "." + t + "d", [e, i]));
              });
            })(m, h.action, h.errors, h.data);
          }
          window.mc4wp = s;
        },
        { "./forms/forms.js": 3, gator: 5 }
      ],
      2: [
        function(e, t, n) {
          "use strict";
          var r = e("form-serialize"),
            i = e("populate.js"),
            o = function(e, t) {
              (this.id = e), (this.element =
                t || document.createElement("form")), (this.name =
                this.element.getAttribute("data-name") ||
                "Form #" + this.id), (this.errors = []), (this.started = !1);
            };
          (o.prototype.setData = function(e) {
            ...
            this.setResponse(""), (this.element.querySelector(
              ".mc4wp-form-fields"
            ).style.display =
              ""), this.element.reset();
          }), (t.exports = o);
        },
        { "form-serialize": 4, "populate.js": 6 }
      ],
      3: [
        function(e, t, n) {
          "use strict";
        ...
        { "./form.js": 2, "wolfy87-eventemitter": 7 }
      ],
      4: [
        function(e, t, n) {
          function r(e, t) {
            ...
            for (
              ...
              if (
                ...
                l.name &&
                (u.test(l.nodeName) && !c.test(l.type))
              ) {
                var h = l.name,
                  d = l.value;
                if (
                  ...
                  if (
                    (
                      "checkbox" !== l.type || l.checked || (d = ""),
                      "radio" === l.type &&
                        (o[l.name] || l.checked
                          ? l.checked && (o[l.name] = !0)
                          : (o[l.name] = !1)),
                      !d && "radio" == l.type
                    )
                  )
            ...
            if (t.empty) for (var h in o) o[h] || (n = r(n, h, ""));
            return n;
          }
          function i(e) {
            var t = [],
          ...
          !(function() {
            ...
            function i(e, t, n) {
              ...
              if (e !== n)
                return r(e).call(e, t)
                  ? e
                  : e.parentNode ? (l++, i(e.parentNode, t, n)) : void 0;
            }
            function o(e, t, n, r) {
              d[e.id] || (d[e.id] = {}), d[e.id][t] || (d[e.id][t] = {}), d[
                e.id
              ][t][n] || (d[e.id][t][n] = []), d[e.id][t][n].push(r);
            }
            function s(e, t, n, r) {
              if (d[e.id])
                if (t) {
            ...
            function a(e, t, n) {
              if (d[e][n]) {
                ...
                l = 0;
                for (r in d[e][n])
                  d[e][n].hasOwnProperty(r) &&
                    (o = i(s, r, m[e].element)) &&
                    u.matchesEvent(n, m[e].element, o, "_root" == r, t) &&
                    (l++, (d[e][n][r].match = o), (a[l] = d[e][n][r]));
                for (
            ...
            function u(e, t) {
              if (!(this instanceof u)) {
                for (var n in m) if (m[n].element === e) return m[n];
                    ...
                    switch (c) {
                      ...
                      case "checkbox":
                        for (var u = 0; u < a.length; u++)
                          a[u].checked = s.indexOf(a[u].value) > -1;
                        break;
                      case "select-multiple":
                        for (
                          var f = s.constructor == Array ? s : [s], l = 0;
                          l < a.options.length;
                          l++
                        )
                          a.options[l].selected |=
                            f.indexOf(a.options[l].value) > -1;
                        break;
                      case "select":
                      case "select-one":
            ...
            (a.getListeners = function(e) {
              ...
              for (r in o)
                o.hasOwnProperty(r) &&
                  ...
                  o[r].splice(n, 1);
              return this;
            }), (a.off = o("removeListener")), (a.addListeners = function(
              e,
              t
            ) {
              ...
              for (o in s)
                if (s.hasOwnProperty(o))
                  for (n = s[o].slice(0), i = 0; i < n.length; i++)
                    (r = n[i]), !0 === r.once &&
                      this.removeListener(e, r.listener), r.listener.apply(
                      this,
                      t || []
