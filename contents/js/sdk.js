/*1503315198,,JIT Construction: v3240711,en_US*/
 ...
 */
            ...
            function a(b, c, d, e, f, g) {
              (function() {
                var h = {}.toString,
                  ...
                  aa,
                  ba,
                  ca = new Date(-3509827334573292),
                  da,
                  ea,
                  fa;
                try {
                  ca =
                    ca.getUTCFullYear() == -109252 &&
                    ca.getUTCMonth() === 0 &&
                    ca.getUTCDate() == 1 &&
                    ca.getUTCHours() == 10 &&
                    ca.getUTCMinutes() == 37 &&
                    ca.getUTCSeconds() == 6 &&
                    ca.getUTCMilliseconds() == 708;
                } catch (ga) {}
                if (!ca) {
                  da = Math.floor;
                ...
                if ((n = typeof l.stringify == "function" && !fa)) {
                  ...
                  try {
                    n =
                      ...
                      l.stringify(new Date(-8.64e15)) ==
                        '"-271821-04-20T00:00:00.000Z"' &&
                      l.stringify(new Date(8.64e15)) ==
                        '"+275760-09-13T00:00:00.000Z"' &&
                      l.stringify(new Date(-62198755200000)) ==
                        '"-000001-01-01T00:00:00.000Z"' &&
                      l.stringify(new Date(-1)) == '"1969-12-31T23:59:59.999Z"';
                  } catch (ga) {
                    n = false;
                  }
                }
                ...
                if (!n || !s) {
                    ...
                    i = function(ga) {
                      ...
                      if (
                        ...
                        i = function(ja) {
                          ...
                          return (
                            ja in this && !(ja in ka && this[ja] === ka[ja])
                          );
                        };
                      }
                      ha = null;
                  ...
                  j = function(ga, ha) {
                    ...
                    ka = new ja();
                    for (la in ka) if (i.call(ka, la)) ia++;
                    ja = ka = null;
                    if (!ia) {
                      ka = [
                        "valueOf",
                      ...
                      ma = function(na, oa) {
                        var pa = h.call(na) == "[object Function]",
                          ...
                          ra;
                        for (qa in na)
                          if (!(pa && qa == "prototype") && i.call(na, qa))
                            oa(qa);
                        for (
                          ra = ka.length;
                          (qa = ka[--ra]);
                      ...
                      for (; (ja = ga.charAt(ia)); ia++)
                        ha +=
                          '\\"\b\f\n\r\t'.indexOf(ja) > -1
                            ? o[ja]
                            : ja < " "
                              ? "\\u00" + p(2, ja.charCodeAt(0).toString(16))
                              : ja;
                      return ha + '"';
                    };
                        ...
                        if (oa == "[object Date]" && !i.call(na, "toJSON")) {
                          if (na > -1 / 0 && na < 1 / 0) {
                            if (fa) {
                              ra = da(na / 86400000);
                              for (
                                pa = da(ra / 365.2425) + 1970 - 1;
                                fa(pa + 1, 0) <= ra;
                                pa++
                              );
                              for (
                                qa = da((ra - fa(pa, 0)) / 30.42);
                                fa(pa, qa + 1) <= ra;
                                qa++
                              );
                              ra = 1 + ra - fa(pa, qa);
                      ...
                      if (
                        ...
                        if (h.call(ha) == "[object Function]") {
                          ...
                          for (
                            ma = 0, na = ha.length;
                            ma < na;
                            oa = ha[ma++], (h.call(oa) == "[object String]" ||
                              h.call(oa) == "[object Number]") &&
                              (la[oa] = 1)
                          );
                        }
                      if (ia)
                        ...
                        } else if (h.call(ia) == "[object String]")
                  ...
                  if (!s) {
                    ...
                    l.parse = function(ga, ha) {
                      ...
                      if (w() != "$") v();
                      aa = ba = null;
                      return ha && h.call(ha) == "[object Function]"
                        ? y(((ca = {}), (ca[""] = ia), ca), "", ha)
                        : ia;
                    };
                  }
          ...
          __d(
            ...
            function a(
              ...
              var w = {}.toString,
                x = { "JSON.stringify": n.stringify, "JSON.parse": n.parse },
                y = {
                  "Array.prototype": h,
                ...
                aa = { Object: u, "String.prototype": t, "Array.prototype": v };
              function ba(da) {
                for (var ea in da) {
                  ...
                  for (var ma in fa) {
                    ...
                    var na = la[ma];
                    x[ea + "." + ma] =
                      na && /\{\s+\[native code\]\s\}/.test(na) ? na : fa[ma];
                  }
                }
              }
              ba(y);
              ...
              function ca(da, ea, fa) {
                ...
                if (typeof ha === "function") {
                  for (
                    var ia = arguments.length,
                      ja = Array(ia > 3 ? ia - 3 : 0),
                      ka = 3;
                    ka < ia;
                    ka++
                  )
                    ja[ka - 3] = arguments[ka];
                  return ha.apply(da, ja);
                } else if (ha) return ha;
                throw new Error(
                  "Polyfill " + ga + " does not have implementation of " + ea
                );
              }
              f.exports = ca;
            },
            ...
            var g = a.FB_enumerate,
              h = (function() {
                ...
                function u(ba) {
                  return (
                    ba != null &&
                    (typeof ba === "object" || typeof ba === "function")
                  );
                }
                function v(ba, ca) {
          ...
          __d("JSSDKXDConfig", [], {
            ...
            XdBundleUrl: "/connect/xd_arbiter/r/XBwzv5Yrm_1.js?version=42",
            Flash: {
              path:
              ...
              var h = {},
                i = function j(k, l, m) {
                  return function() {
                    ...
                    for (
                      var o = arguments.length, p = Array(o), q = 0;
                      q < o;
                      q++
                    )
                      p[q] = arguments[q];
          ...
          __d(
            ...
            function a(b, c, d, e, f, g, h, i) {
              ...
              function k(n, o, p) {
                ...
                if (q) {
                  document.cookie =
                    n + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT;";
                  document.cookie =
                    n +
              ...
              var m = {
                setDomain: function n(o) {
                  j = o;
                  var p = h.encode({ base_domain: j && j !== "." ? j : "" }),
                    q = new Date();
                ...
                setSignedRequestCookie: function n(o, p) {
                  if (!o)
                    throw new Error(
                      "Value passed to Cookie.setSignedRequestCookie " +
                        "was empty."
                    );
                  k("fbsr_", o, p);
                },
          ...
          __d(
            ...
            function a(b, c, d, e, f, g) {
              ...
              function k(m) {
                m =
                  (j.charCodeAt(m.charCodeAt(0) - 43) << 18) |
          ...
          __d(
            ...
            function a(b, c, d, e, f, g) {
              ...
              i.prototype.merge = function(j, k) {
                "use strict";
                this._queue[k ? "unshift" : "push"].apply(
                  this._queue,
                  j._queue
                );
                j._queue = [];
                ...
                m = function p(q, r, s) {
                  var t =
                    arguments.length <= 3 || arguments[3] === undefined
                      ? false
                      : arguments[3];
                  s.wrapper = j(s, "entry", "DOMEventListener.add " + r);
                  q.addEventListener(r, s.wrapper, k ? t : false);
                };
                n = function p(q, r, s) {
                  var t =
                    arguments.length <= 3 || arguments[3] === undefined
                      ? false
                      : arguments[3];
                  q.removeEventListener(r, s.wrapper, k ? t : false);
                };
              } else if (window.attachEvent) {
                m = function p(q, r, s) {
                  s.wrapper = j(s, "entry", "DOMEventListener.add " + r);
                  q.attachEvent || i(0);
                  q.attachEvent("on" + r, s.wrapper);
                };
                n = function p(q, r, s) {
                  q.detachEvent || i(0);
                  q.detachEvent("on" + r, s.wrapper);
                };
              } else n = m = h;
              var o = {
                add: function p(q, r, s) {
                  var t =
                    arguments.length <= 3 || arguments[3] === undefined
                      ? false
                      : arguments[3];
            ...
            function a(b, c, d, e, f, g) {
              ...
              function x() {
                ...
                var z = navigator.userAgent,
                  aa = /(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(
                    z
                  ),
              ...
              var u = {
                embed: function v(w, x, y, z) {
                  ...
                  y = babelHelpers["extends"](
                    { allowscriptaccess: "always", flashvars: z, movie: w },
                    y
                  );
                  if (typeof y.flashvars == "object")
                    y.flashvars = j.encode(y.flashvars);
                  var ba = [];
                  for (var ca in y)
                    if (Object.prototype.hasOwnProperty.call(y, ca) && y[ca])
                      ba.push(
                        '<param name="' + m(ca) + '" value="' + m(y[ca]) + '">'
                      );
                ...
                getVersion: function v() {
                  ...
                  if (
                    navigator.plugins &&
                    typeof navigator.plugins[w] == "object"
                  ) {
                    ...
                    if (
                      ...
                      navigator.mimeTypes[x].enabledPlugin
                    )
                      z = aa.match(/\d+/g);
                  }
                  if (!z)
                    try {
                      z = new ActiveXObject(y)
                        .GetVariable("$version")
                        .match(/(\d+),(\d+),(\d+),(\d+)/);
              ...
              var u = {
                ...
                create: function w(x) {
                  if (!x.whenReady && !x.onMessage) {
                    ...
                    throw new Error(
                      "An instance without whenReady or " +
                      ...
                      h.add(
                        ...
                        p(
                          function(event) {
                            ...
                            if (ba.substring(0, z.length) == z)
                              ba = ba.substring(z.length);
                            y.onMessage(ba, ca);
                          },
                          "entry",
                          "onMessage"
          ...
          __d(
            ...
            function a(b, c, d, e, f, g) {
              ...
              function j(k) {
                ...
                return (
                  ES(i, "indexOf", true, k.getProtocol()) !== -1 &&
                  h.test(k.getDomain())
                );
              }
            ...
            function a(b, c, d, e, f, g) {
              var h = {
                ...
                subscribe: function i(j, k) {
                  ...
                  if (j != this.SUBSCRIBE && j != this.UNSUBSCRIBE)
                    this.fire(this.SUBSCRIBE, j, l[j]);
                },
                unsubscribe: function i(j, k) {
                  var l = this.subscribers()[j];
                  if (l)
                    ES(l, "forEach", true, function(m, n) {
                      if (m == k) l.splice(n, 1);
                    });
                  if (j != this.SUBSCRIBE && j != this.UNSUBSCRIBE)
                    this.fire(this.UNSUBSCRIBE, j, l);
                },
                monitor: function i(j, k) {
                  if (!k()) {
                    var l = this,
              ...
              i.prototype.stub = function(j) {
                ...
                this.remote[j] = ES(
                  function() {
                    ...
                    for (
                      var l = arguments.length, m = Array(l), n = 0;
                      n < l;
                      n++
                    )
                      m[n] = arguments[n];
                    ...
                    k.params = m;
                    this.$JSONRPC4(
                      ES("JSON", "stringify", false, k),
                      this.$JSONRPC3 || { method: j }
                    );
                  },
                  "bind",
                  true,
              ...
              function m(n) {
                ...
                for (var w in v)
                  if (Object.prototype.hasOwnProperty.call(v, w))
                    o.setAttribute(w, v[w]);
                ES("Object", "assign", false, o.style, r);
                o.src = i();
                q.appendChild(o);
                if (t)
                  var x = h.add(o, "load", function() {
                    x.remove();
                    t();
                  });
                if (u)
                  var y = h.add(o, "error", function() {
                    y.remove();
                    u();
                  });
                o.src = s;
          ...
          __d(
            ...
            function a(
              ...
              function pa(va) {
                ...
                n.setEnvironment(
                  va === "canvas"
                    ? n.ENVIRONMENTS.CANVAS
                    : n.ENVIRONMENTS.PAGETAB
                );
              }
              function qa(va, wa) {
                if (!wa) {
                ...
                switch (va.xd_action) {
                  case "proxy_ready":
                    ...
                    j.info(
                      "Proxy ready, starting queue %s containing %s messages",
                      xa + "ProxyQueue",
                      ya.getLength()
                    );
                    ya.start(function(bb) {
                      ka.send(
                        typeof bb === "string" ? bb : k.encode(bb),
                        wa,
                        za.contentWindow,
                        ia + "_" + xa
                      );
              ...
              i.subscribe("init:post", function(va) {
                ...
                if (wa)
                  setTimeout(function() {
                    var xa =
                      ba && !!aa == y.isStarted() && !!ba == z.isStarted();
                    if (!xa)
                      o.log("jssdk_error", {
                        appId: n.getClientID(),
            ...
            function a(
              ...
              function ba(ja, ka) {
                ...
                var oa = q.getLoginStatus(),
                  pa =
                    (oa === "unknown" && ja) ||
                    (q.getUseCookie() && q.getCookieUserID() !== ma),
                  qa = la && !ja,
                  ra = ja && la && la != ma,
                  sa = ja != y,
                  ta = ka != (oa || "unknown");
                ...
                q.setUserID(ma);
                y = ja;
                var ua = { authResponse: ja, status: ka };
              ...
              function da(ja, ka, la) {
                return function(ma) {
                  ...
                  if (ma && ma.access_token) {
                    ...
                    if (q.getUseCookie()) {
                      var pa =
                          ka.expiresIn === 0
                            ? 0
                            : ES("Date", "now", false) + ka.expiresIn * 1000,
                        qa = h.getDomain();
                      if (!qa && ma.base_domain)
                  ...
                  if (ja) ja({ authResponse: ka, status: q.getLoginStatus() });
                  return ka;
                };
              }
              function ea() {
              ...
              function ga(ja) {
                var ka,
                  la = ES("Date", "now", false);
                if (z) {
                  clearTimeout(z);
                  z = null;
                }
                var ma = h.getRaw(w) === "y";
                if (k("getloginstatus_tracking", true))
                  r.log("jssdk_error", {
                    appId: q.getClientID(),
                ...
                if (ma) {
                  var na = "unknown";
                  ba(null, na);
                  if (ja) ja({ authResponse: null, status: na });
                  return;
                }
                var oa = da(ja, y, "login_status"),
                  pa = new u(
                    t.resolve("www", true) + "/connect/ping"
                  ).setQueryData({
              ...
              function ia(ja, ka) {
                ...
                if (ja)
                  if (!ka && ha == "loaded") {
                    ja({ status: q.getLoginStatus(), authResponse: ca() });
                    return;
          ...
          __d(
            "sdk.DOM",
            ["Assert", "sdk.UA", "sdk.domReady"],
            function a(b, c, d, e, f, g, h, i, j) {
              var k = {};
              function l(z, aa) {
                var ba =
                  z.getAttribute(aa) ||
                  z.getAttribute(aa.replace(/_/g, "-")) ||
                  z.getAttribute(aa.replace(/-/g, "_")) ||
                  z.getAttribute(aa.replace(/-/g, "")) ||
                  z.getAttribute(aa.replace(/_/g, "")) ||
                  z.getAttribute("data-" + aa) ||
              ...
              function n(z, aa) {
                ...
                try {
                  ...
                  throw new Error(
                    "Could not read property " + aa + " : " + ba.message
                  );
                }
              }
              function o(z, aa) {
              ...
              function t(z, aa) {
                ...
                var ba =
                    z.currentStyle ||
                    document.defaultView.getComputedStyle(z, null),
                  ca = ba[aa];
                ...
                function p(t, u) {
                  return function() {
                    ...
                    try {
                      ...
                      v.args = ES("JSON", "stringify", false, w).substring(
                        0,
                        200
                      );
                      o(v);
          ...
          __d(
            ...
            function a(
                ...
                switch (ha) {
                  ...
                  default:
                    return m.guard(function() {
                      if (ha === "warn") {
                        r.warn(
                          "The method FB.%s is not officially supported by " +
                            "Facebook and access to it will soon be removed.",
                          ea
                        );
                        if (!Object.prototype.hasOwnProperty.call(y, ea)) {
                          q.log(
                            q.TYPE.WARNING,
                            q.CATEGORY.DEPRECATED,
                            "FB." + ea
                          );
                          t.log("jssdk_error", {
                            appId: s.getClientID(),
              ...
              function ca(da, ea) {
                ...
                ES(ES("Object", "keys", false, ea), "forEach", true, function(
                  ga
                ) {
                  var ha = ea[ga];
                  if (typeof ha === "function") {
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m) {
              ...
              function o(p) {
                ...
                try {
                  ...
                  throw new h(w.message, w);
                }
                ES(p, "forEach", true, function(w) {
                  return (s[typeof w] = w);
                });
                var t = (s.string || "get").toLowerCase();
                i.isTrue(
                  Object.prototype.hasOwnProperty.call(n, t),
                  m("Invalid method passed to ApiClient: %s", t)
                );
                var u = s["function"];
                if (!u) j.warn("No callback passed to the ApiClient");
                if (s.object) r.addQueryData(l(s.object));
                var v = r.getQueryData();
                v.method = t;
                return { uri: r, callback: u, params: v };
              }
            ...
            function a(b, c, d, e, f, g, h, i, j, k) {
              ...
              n.prototype.scheduleBatchCall = function() {
                ...
                if (this.$ApiBatcher1.length == l) {
                  ...
                  this.$ApiBatcher5();
                } else if (!this.$ApiBatcher4)
                  this.$ApiBatcher4 = setTimeout(
                    ES(
                      function() {
                        this.$ApiBatcher5();
                      },
              ...
              n.prototype.$ApiBatcher5 = function() {
                ...
                this.executeRequest(
                  ...
                  function(t) {
                    if (ES("Array", "isArray", false, t)) {
                      ES(t, "forEach", true, function(u, v) {
                        p[v](k(u && u.body));
                      });
                    } else
                      ES(p, "forEach", true, function(u) {
                        return u({
            ...
            function a(b, c, d, e, f, g, h, i, j) {
              ...
              function m(p, q, r, s) {
                ...
                if (t.addEventListener) {
                  t.addEventListener("load", v, false);
                } else
          ...
          __d(
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
              var t,
                ...
                ba = 0,
                ca;
              function da(ka, la, ma, na) {
                var oa = ba !== 0 && z >= ba;
                if (oa) {
                  aa.push(function() {
                    return da(ka, la, ma, na);
                  });
                  ia.inform("request.queued", ka, la, ma);
                  return;
                }
                z++;
                if (v) ma = ES("Object", "assign", false, {}, v, ma);
                ma.pretty = ma.pretty || 0;
                ma = m(ma);
                var pa = { jsonp: n, cors: k, flash: l },
                  qa = {},
                  ra = ma.access_token || t;
                if (ra) qa.access_token = ra;
                var sa = ES("Object", "keys", false, qa);
                if (sa.length > 0) {
                  ka = q.appendToUrl(ka, qa);
                  ES(sa, "forEach", true, function(xa) {
                    return delete ma[xa];
                  });
                }
                var ta;
                ...
                for (var ua = 0; ua < ta.length; ua++) {
                  var va = pa[ta[ua]],
                    wa = ES("Object", "assign", false, {}, ma);
                  if (va.execute(ka, la, wa, na)) return;
                }
                na({
                  error: {
                    type: "no-transport",
              ...
              function fa() {
                for (
                  var ka = arguments.length, la = Array(ka), ma = 0;
                  ma < ka;
                  ma++
                )
                  la[ma] = arguments[ma];
                var na = i.parseCallDataFromArgs(la),
                  oa = na.uri,
                  pa = na.callback,
                  qa = na.params,
                  ra = qa.method;
                if (ja(oa, ra)) ra = "post";
                var sa =
                  oa.getProtocol() && oa.getDomain()
                    ? oa.setQueryData({}).toString()
                    : r.resolve("graph") + oa.getPath();
                ia.inform("request.prepare", sa, qa);
                da(
                  sa,
                  ra == "get" ? "get" : "post",
                  qa,
              ...
              function ga() {
                var ka;
                if (!ca) ca = new h(fa, u);
                (ka = ca).scheduleBatchCall.apply(ka, arguments);
              }
              function ha(ka, la) {
                j.isObject(ka);
                j.isString(ka.method, "method missing");
                if (!la) o.warn("No callback passed to the ApiClient");
                var ma = ka.method.toLowerCase().replace(".", "_");
                ka.format = "json-strings";
                ka.api_key = u;
                var na = ma in x ? "api_read" : "api",
                  oa = r.resolve(na) + "/restserver.php",
                  pa = ES(
                    ea,
                    "bind",
                    true,
              ...
              var ia = ES("Object", "assign", false, new p(), {
                setAccessToken: function ka(la) {
                  t = la;
                },
                setAccessTokenForClientID: function ka(la, ma) {
                  if (!(t && u && u !== ma)) t = la;
                },
                getAccessToken: function ka() {
                  return t;
                },
                setClientID: function ka(la) {
                  u = la;
                },
                setDefaultParams: function ka(la) {
                  v = la;
                },
                setDefaultTransports: function ka(la) {
                  y = la;
                },
                setMaxConcurrentRequests: function ka(la) {
                  ba = la;
                },
                getCurrentlyExecutingRequestCount: function ka() {
                  return z;
                },
                getQueuedRequestCount: function ka() {
                  return aa.length;
                },
                rest: ha,
                graph: fa,
                scheduleBatchCall: ga,
                prepareBatchParams: h.prepareBatchParams
              });
              function ja(ka, la) {
                return ka.toString().length > w && la === "get";
              }
              l.setSwfUrl(s.FlashRequest.swfUrl);
              f.exports = ia;
            },
            null
          );
          ...
          __d(
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                ...
                if (t && typeof t == "object")
                  if (t.error) {
                    if (
                      ...
                      (t.error.type == "OAuthException" && t.error.code == 190)
                    )
                      u = true;
              ...
              h.subscribe("request.complete", function(q, r, s, t) {
                if (
                  ((q == "/me/permissions" && r === "delete") ||
                    (q == "/restserver.php" &&
                      s.method == "Auth.revokeAuthorization")) &&
                  t === true
                )
              ...
              function p(q) {
                if (typeof q === "string") {
                  if (j.getIsVersioned()) {
                    ...
                    if (
                      !i.REGEX.test(
                        q.substring(1, ES(q, "indexOf", true, "/", 1))
                      )
                    )
                      q = "/" + j.getVersion() + q;
                    var r = [q].concat(
          ...
          __d(
            ...
            function a(b, c, d, e, f, g) {
              ...
              function r(w) {
                return ES("Array", "isArray", false)
                  ? ES("Array", "isArray", false, w)
                  : m.call(w) === "[object Array]";
              }
              function s(w) {
          ...
          __d(
            "FBPixelEndpoint",
            ["FBEventsParamList", "FBEventsUtils"],
            function a(b, c, d, e, f, g, h, i) {
              "use strict";
            ...
            function a(b, c, d, e, f, g, h, i) {
              ...
              function k(l, m, n, o) {
                var p = "/" + m + "/user_properties",
                  q = { data: [{ user_unique_id: l, custom_data: n }] };
                h.graph(p, "post", q, o);
              }
          ...
          __d(
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
              var p = {
                ...
                y = 100,
                z = 100,
                aa = ES("Object", "values", false, h),
                ba = new l({ UserID: "", Version: "" });
              function ca(ta, ua, va, wa) {
                var xa = { ae: 1, ev: ua, vts: va, canvas: 1 };
                if (wa) xa.cd = wa;
                k.impression({
                  api_key: ta,
                  payload: ES("JSON", "stringify", false, xa)
                });
              }
              function da(ta, ua, va, wa) {
                var xa = o.getAuthResponse(),
                  ya = xa && xa.accessToken ? xa.accessToken : null;
                n.logEvent(ta, ua, wa || {}, va, ya);
              }
              function ea(ta, ua, va, wa) {
                fa(ua);
                var xa = ba.getUserID();
                if (xa !== "") {
                  wa = wa || {};
                ...
                var ya = ba.getVersion();
                if (ya !== "") {
                  wa = wa || {};
                  wa[r.APP_VERSION] = ya;
                }
                if (m.isCanvasEnvironment()) {
                  ca(ta, ua, va, wa);
                } else da(ta, ua, va, wa);
              }
              function fa(ta) {
              ...
              function ga(ta, ua, va, wa) {
                var xa = {};
                xa[r.CURRENCY] = va;
                ea(ta, q.PURCHASED, ua, babelHelpers["extends"]({}, wa, xa));
              }
              function ha(ta) {
                ea(ta, q.ACTIVATED_APP);
              }
              function ia(ta) {
                ea(ta, p.PAGE_VIEW);
              }
              ...
              function ra(ta) {
                i.isTrue(
                  ES("Object", "keys", false, ta).length <= y,
                  "The total number of user properties cannot exceed " + y + "."
                );
                for (var ua in ta) {
                  i.isTrue(
                    u.test(ua) || ES(aa, "includes", true, ua),
              ...
              function sa(ta, ua, va) {
                var wa = la();
                ja(wa);
                ra(ua);
                n.updateUserProperties(wa, ta, ua, va);
              }
              j.subscribe("init:post", function(ta) {
                if (m.getClientID()) {
                  if (ta.autoLogAppEvents !== undefined) {
                    i.isBoolean(
                      ta.autoLogAppEvents,
                      "Type of property autoLogAppEvents must be boolean"
                    );
                    m.setAutoLogAppEvents(ta.autoLogAppEvents);
                  }
                  if (m.getAutoLogAppEvents()) ia(m.getClientID());
                }
              });
              f.exports = {
                activateApp: ha,
                ...
                logPurchase: ga,
                logPageView: ia,
                assertValidEventName: fa,
                EventNames: p,
                ParameterNames: r,
                assertValidUserID: ja,
                setUserID: ka,
                getUserID: la,
                clearUserID: ma,
                assertValidUserProperties: ra,
                updateUserProperties: sa,
                setAppVersion: oa,
                getAppVersion: pa,
                clearAppVersion: qa,
                assertValidAppVersion: na
              };
            },
            null
          );
          __d(
            "legacy:fb.appevents",
            ["Assert", "sdk.AppEvents", "FB", "sdk.Runtime"],
            function a(b, c, d, e, f, g, h, i, j, k) {
              function l() {
                var m = k.getClientID();
                h.isTrue(
              ...
              var m = {
                ...
                addIdleDesktopAction: function n(o, p, q) {
                  ...
                  return j.add(o, "mouseenter", function() {
                    clearTimeout(r);
                    if (!event)
                      event = j.add(o, "mouseleave", function() {
                        s();
                      });
                  });
                },
                ...
                setDialogPositionToCenter: function n(o, p, q) {
                  ...
                  var x = s.height - u - w,
                    y = (s.height - u) / 2;
                  if (q)
                    y = q.scrollTop - q.offsetTop + (q.clientHeight - u) / 2;
                  if (y < w) {
                    y = w;
                  } else if (y > x) y = x;
                  y += s.scrollTop;
                  if (k.mobile()) {
                    ...
                    if (p) {
                      ...
                      if (l("dialog_resize_refactor", false))
                ...
                setDialogPositionToTop: function n(o, p, q) {
                  ...
                  var r = i.getViewportInfo(),
                    s = r.scrollTop + (r.height - o.offsetHeight) * 0.05;
              ...
              var y = o.extend(
                  {
                    ...
                    trackEvents: function aa(ba) {
                      if (typeof ba === "string")
                        ba = ES("JSON", "parse", false, ba);
                      for (var ca in ba)
                        if (Object.prototype.hasOwnProperty.call(ba, ca))
                          this.trackEvent(ca, ba[ca]);
                      return this;
                    }
                  },
                  m
                ...
                z = {
                  ...
                  _createMobileLoader: function aa() {
                    ...
                    return z.create({
                      classes:
                        "loading" + (z.isTabletStyle() ? " centered" : ""),
                      content: ba
                    });
                  },
                  ...
                  _showTabletOverlay: function aa(ba) {
                    ...
                    if (z._closeOnOverlayTap) {
                      var ca = j.addDoubleClickAction(
                        z._overlayEl,
                        ES(ba, "bind", true, this),
                        5000
                      );
                  ...
                  showLoader: function aa(ba, ca) {
                    ...
                    if (!z._loaderEl)
                      z._loaderEl = z._findRoot(
                        p.mobile()
                          ? z._createMobileLoader()
                          : z._createWWWLoader(ca)
                      );
                  ...
                  _hideLoader: function aa() {
                    if (z._loaderEl && z._loaderEl == z._active)
                      z._loaderEl.style.top = "-10000px";
                  },
                  ...
                  _centerActive: function aa(ba) {
                    ...
                    if (!ca) return;
                    if (
                      z._positionDialogAtTopWhenPortrait &&
                      j.isOrientationPotrait()
                    ) {
                      j.setDialogPositionToTop(ca, z.isTabletStyle(), ba);
                    } else
                      j.setDialogPositionToCenter(ca, z.isTabletStyle(), ba);
                  },
                  _setDialogSizes: function aa() {
                    ...
                    for (var ca in z._dialogs)
                      if (
                        Object.prototype.hasOwnProperty.call(z._dialogs, ca)
                      ) {
                        var da = document.getElementById(ca);
                        if (da) {
                          da.style.width = z.getDefaultSize().width + "px";
                          if (!ba)
                            da.style.height = z.getDefaultSize().height + "px";
                        }
                      }
                  },
                  getDefaultSize: function aa() {
                    if (p.mobile()) {
                      var ba = x();
                      if (ba) {
                        if (k.getViewportInfo().width <= ba.width)
                          ba.width = k.getViewportInfo().width - s;
                        if (k.getViewportInfo().height <= ba.height)
                          ba.height = k.getViewportInfo().height - s;
                        return ba;
                      }
                  ...
                  _handleOrientationChange: function aa() {
                    var ba = r("dialog_resize_refactor", false)
                      ? k.getViewportInfo().width
                      : screen.availWidth;
                    ...
                    if (z.isTabletStyle()) {
                      ...
                      for (var da in z._dialogs)
                        if (
                          Object.prototype.hasOwnProperty.call(z._dialogs, da)
                        ) {
                  ...
                  _addOrientationHandler: function aa() {
                    ...
                    z._availScreenWidth = r("dialog_resize_refactor", false)
                      ? k.getViewportInfo().width
                      : screen.availWidth;
                    j.addMobileOrientationChangeAction(
                      z._handleOrientationChange
                    );
                  },
                  create: function aa(ba) {
                    ...
                    if (typeof ba.styles === "object")
                      ES(
                        "Object",
                        "assign",
                        false,
                        ca.dialogElement.style,
                        ba.styles
                      );
                  ...
                  remove: function aa(ba) {
                    ...
                    if (ba) {
                      ...
                      } else if (z._active === null && z._stack.length > 0)
                        z.show(z._stack.pop());
                      setTimeout(function() {
          ...
          __d(
            "sdk.Frictionless",
            ["sdk.Auth", "sdk.api", "sdk.Event", "sdk.Dialog"],
            function a(b, c, d, e, f, g, h, i, j, k) {
              var l = {
                _allowedRecipients: {},
            ...
            function a(b, c, d, e, f, g, h) {
              ...
              function l(m) {
                ...
                if (h.android()) {
                  ...
                  if (q)
                    n += "S.platform_app_id=" + encodeURIComponent(q) + ";";
                  n += "end";
                  o = j;
                } else {
            ...
            function a(
              ...
              var fa = {
                  transform: function la(ma) {
                    if (
                      ma.params.display === "touch" &&
                      ka.canIframe(ma.params) &&
                      window.postMessage
                    ) {
                  ...
                  getXdRelation: function la(ma) {
                    var na = ma.display;
                    if (na === "touch" && window.postMessage && ma.in_iframe)
                      return "parent";
                ...
                ga = {
                  "stream.share": {
                    ...
                    transform: function la(ma) {
                      if (!ma.params.u)
                        ma.params.u = window.location.toString();
                    ...
                    transform: function la(ma) {
                      ...
                      var pa = ES(
                        ...
                        ES(
                          ...
                          "assign",
                          false,
                          ma.params.response_type
                            ? w(ma.params.response_type.split(","))
                            : {},
                  ...
                  live_broadcast: {
                    transform: function la(ma) {
                      if (ma.params.phase === "create")
                        ma.size = { width: 480, height: 280 };
                      if (ma.params.phase === "publish")
                        ma.size = { width: 772, height: 540 };
                      return ma;
                    },
              ...
              var ka = {
                ...
                checkOauthDisplay: function la(ma) {
                  ...
                  for (var pa = 0; pa < oa.length; pa++)
                    if (
                      !s.initSitevars.iframePermissions[
                        ES(oa[pa], "trim", true)
                      ]
                    )
                      return "popup";
                ...
                prepareCall: function la(ma, na) {
                  var oa = ma.method.toLowerCase(),
                    pa = Object.prototype.hasOwnProperty.call(ka.Methods, oa)
                      ? ES("Object", "assign", false, {}, ka.Methods[oa])
                      : {},
                    qa = ba(),
                    ra =
                      r.getSecure() ||
                      (oa !== "auth.status" && oa != "login.status");
                  ...
                  if (oa === "share" || oa === "share_open_graph") {
                    ma.mobile_iframe =
                      t.mobile() && (ma.mobile_iframe || ma.iframe_test);
                    if (ma.mobile_iframe)
                      pa = ES("Object", "assign", false, {}, fa);
                  }
                  ma.display = ka.getDisplayMode(pa, ma);
                  if (!pa.url) pa.url = "dialog/" + oa;
                  if (
                    (pa.url == "dialog/oauth" ||
                      pa.url == "dialog/permissions.request") &&
                    (ma.display == "iframe" ||
                      (ma.display == "touch" && ma.in_iframe))
                  )
                    ma.display = ka.checkOauthDisplay(ma);
                  if (ma.display == "popup" && !pa.require_access_token)
                    delete ma.access_token;
                  if (
                    r.getIsVersioned() &&
                    pa.url.substring(0, 7) === "dialog/"
                  )
                    pa.url = ma.version + "/" + pa.url;
                  if (ja(ma)) {
                    if (ha[oa]) {
                      var sa =
                        'Dialog "' + oa + '" is trying to run more than once.';
                      n.warn(sa);
                      na({ error_code: -100, error_message: sa });
                      return;
                    }
                    na = ia(na, oa);
                  }
                  var ta = {
                      ...
                      url:
                        u.resolve(ma.display == "touch" ? "m" : "www", ra) +
                        "/" +
                        pa.url,
                      params: ma,
                      name: oa,
                  ...
                  if (ma.display === "touch" && ma.in_iframe)
                    ta.params.parent_height = window.innerHeight;
                  var va = pa.getXdRelation || ka.getXdRelation,
                    wa = va(ta.params);
                  if (
                    !(ta.id in ka._defaultCb) &&
                    !("next" in ta.params) &&
                    !("redirect_uri" in ta.params)
                  )
                    ta.params.next = ka._xdResult(ta.cb, ta.id, wa, true);
                  if (wa === "parent" || wa === "opener")
                    ES(
                      "Object",
                      "assign",
                      false,
                      ta.params,
                      {
                        channel_url: ka._xdChannelHandler(
                          qa,
                          wa === "parent" ? "parent.parent" : "opener"
                        )
                      },
                      true
                    );
                ...
                prepareParams: function la(ma) {
                  ...
                  ma.params.kid_directed_site =
                    r.getKidDirectedSite() || ma.params.kid_directed_site;
                ...
                getDisplayMode: function la(ma, na) {
                  if (
                    ...
                    return na.display;
                  var oa =
                    r.isEnvironment(r.ENVIRONMENTS.CANVAS) ||
                    r.isEnvironment(r.ENVIRONMENTS.PAGETAB);
                ...
                popup: function la(ma) {
                  ...
                  if (
                    ma.name == "permissions.request" ||
                    ma.name == "permissions.oauth"
                  ) {
                    wa.push("toolbar=0");
                    if (!t.chrome() || t.chrome() < 59) wa.push("location=1");
                  }
                  wa = wa.join(",");
                  var xa;
                  if (ma.post) {
                    xa = window.open("about:blank", ma.id, wa);
                    if (xa) {
                      ka.setLoadedNode(ma, xa, "popup");
                      i.submitToTarget({
                        url: ma.url,
                        target: ma.id,
                        params: ma.params
                    ...
                    xa = window.open(ma.url, ma.id, wa);
                    if (xa) ka.setLoadedNode(ma, xa, "popup");
                  }
                  if (!xa) return;
                ...
                setLoadedNode: function la(ma, na, oa) {
                  ...
                  na = { node: na, type: oa, fbCallID: ma.id };
                ...
                iframe: function la(ma) {
                  ...
                  var na = function pa() {
                    ...
                    oa = {
                      onClose: na,
                      closeIcon:
                        ma.closeIcon === undefined ? true : ma.closeIcon,
                      classes: k.isTabletStyle() ? "centered" : ""
                    };
                  if (ma.params.mobile_iframe)
                    oa.styles = { "border-radius": "8px" };
                  ma.root = k.create(oa);
                ...
                _insertIframe: function la(ma) {
                  ...
                  var na = function oa(pa) {
                    if (ma.id in ka._loadedNodes)
                      ka.setLoadedNode(ma, pa, "iframe");
                  };
                  if (ma.post) {
                    ca({
                      url: "about:blank",
                  ...
                  return v.handler(
                    function(oa) {
                      ...
                      if (oa.type == "resize") {
                        ...
                        k.show(qa);
                      } else if (oa.type == "fireevent") l.fire(oa.event, oa);
                    },
                    na,
                    true,
                    null
                ...
                _xdRecv: function la(ma, na) {
                  ...
                  if (ma.e2e) {
                    var pa = k.get(ma.frame);
                    pa.trackEvents(ma.e2e);
                    pa.trackEvent("close");
                    delete ma.e2e;
                  }
                  na(ma);
                ...
                _xdResult: function la(ma, na, oa, pa) {
                  return (
                    ka._xdNextHandler(
                      function(qa) {
                        ma &&
                          ma(
                            qa.result &&
                              qa.result != ka._resultToken &&
                              ES("JSON", "parse", false, qa.result)
                          );
                      },
                      na,
                      oa,
                    ...
                    "&result=" +
                    encodeURIComponent(ka._resultToken)
                  );
                },
                xdHandler: function la(ma, na, oa, pa, qa) {
                  return ka._xdNextHandler(
                    h.xdResponseWrapper(ma, pa, qa),
                    na,
                    oa,
                    true
                  );
          ...
          __d(
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m, n) {
              function o(p, q) {
                ...
                if (
                  (r == "permissions.request" || r == "permissions.oauth") &&
                  (p.display == "iframe" || p.display == "dialog")
                )
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
              k.provide("", {
                ...
                login: function p(q, r) {
                  ...
                  var s =
                    m.isEnvironment(m.ENVIRONMENTS.CANVAS) ||
                    m.isEnvironment(m.ENVIRONMENTS.PAGETAB);
                  o(
              ...
              h.subscribe(
                "authresponse.change",
                ES(j.fire, "bind", true, j, "auth.authResponseChange")
              );
              h.subscribe(
                "status.change",
                ES(j.fire, "bind", true, j, "auth.statusChange")
              );
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l) {
              ...
              function v(ba) {
                var ca = ba.type ? ba.type.toLowerCase() : null,
                  da =
                    ca === "application/x-shockwave-flash" ||
                    (ba.classid && ba.classid.toUpperCase() == m);
                if (!da) return false;
                ...
                for (var fa = 0; fa < ba.childNodes.length; fa++) {
                  ...
                  if (
                    /param/i.test(ga.nodeName) &&
                    /wmode/i.test(ga.name) &&
                    ea.test(ga.value)
                  )
                    return false;
                }
              ...
              function w(ba) {
                var ca = ba.type ? ba.type.toLowerCase() : null;
                return (
                  ca === "application/vnd.unity" ||
                  (ba.classid && ba.classid.toUpperCase() == n)
                );
              }
              function x(ba) {
                var ca = ES(
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
              ...
              j.subscribe("init:post", function(r) {
                if (p.isEnvironment(p.ENVIRONMENTS.CANVAS)) {
                  h.isTrue(
                    !r.hideFlashCallback || !r.hidePluginCallback,
                    "cannot specify deprecated hideFlashCallback and new hidePluginCallback"
                  );
                  n._setHidePluginCallback(
                    r.hidePluginCallback || r.hideFlashCallback
                  );
                }
              });
            },
          ...
          __d(
            ...
            function a(b, c, d, e, f, g, h, i, j) {
              ...
              function p() {
                ...
                if (n == k.AUTOMATIC)
                  ES(ES("Object", "keys", false, u), "forEach", true, function(
                    v
                  ) {
                    var w = u[v];
                    ES(
              ...
              function q() {
                ...
                if (
                  Math.random() > 1 / l ||
                  m == "*" ||
                  ~ES(m, "indexOf", true, i.getClientID())
                )
                  return;
                setTimeout(p, 30000);
              }
          ...
          __d(
            "legacy:fb.event",
            ["FB", "sdk.Event", "sdk.Runtime", "sdk.Scribe", "sdk.feature"],
            function a(b, c, d, e, f, g, h, i, j, k, l) {
              var m = [],
                n = null,
            ...
            function a(
              ...
              function v(w) {
                ...
                if (q.getIsVersioned()) {
                  ...
                  if (!w.version)
                    w.version = new s(location.href).getQueryData().sdk_version;
                  ...
                  function(x) {
                    if (x.src) {
                      ...
                      if (y) {
                        var z = p.decode(y[2]);
                        for (var aa in z)
                          if (Object.prototype.hasOwnProperty.call(z, aa)) {
                            var ba = z[aa];
                            if (ba == "0") z[aa] = 0;
                          }
                        v(z);
          ...
          __d(
            ...
            function a(
              ...
              function aa(ha) {
                return function(ia) {
                  var ja = { width: ia.width, height: ia.height, pluginID: ha };
              ...
              function ca(ha, ia) {
                var ja =
                  ...
                  ha[ia.replace(/_/g, "")] ||
                  ha["data-" + ia] ||
                  ha["data-" + ia.replace(/_/g, "-")] ||
                  ha["data-" + ia.replace(/_/g, "")] ||
                  undefined;
                return ja;
              }
              function da(ha, ia, ja, ka) {
                ES(ES("Object", "keys", false, ha), "forEach", true, function(
                  la
                ) {
                  if (ha[la] == "text" && !ja[la]) {
              ...
              var ga = p.extend(
                {
                  constructor: function ha(ia, ja, ka, la) {
                    ...
                    this.subscribe(
                      ...
                      ES(
                        function(ra) {
                          if (
                            ra.reposition === "true" &&
                            v("reposition_iframe", false)
                          )
                            this.reposition(ea(ra.width));
                          z(this._iframe, ea(ra.width), ea(ra.height));
                          this._isIframeResized = true;
                          this.updateLift();
                          clearTimeout(this._timeoutID);
                    ...
                    var na =
                        s.resolve("www", true) + "/plugins/" + ka + ".php?",
                      oa = {};
                    ...
                    if (this.shouldIgnoreWidth()) oa.width = void 0;
                    ...
                    this._iframeOptions = {
                      ...
                      name: pa,
                      width:
                        this._config.mobile_fullsize && q.mobile()
                          ? void 0
                          : oa.width || 1000,
                  ...
                  process: function ha() {
                    if (o.getIsVersioned()) {
                      ...
                      this._iframeOptions.url = ia
                        .setPath("/" + o.getVersion() + ia.getPath())
                        .toString();
                    }
                    ...
                    var ka = n.encode(ja);
                    if (
                      this._element.getAttribute("fb-iframe-plugin-query") == ka
                    ) {
                      k.info(
                  ...
                  reposition: function ha(ia) {
                    ...
                    if (ja + ia > ka && ja > ia) {
                      this._iframe.style.left =
                        parseInt(i.getStyle(this._iframe, "width"), 10) -
                        ia +
                        "px";
          ...
          __d(
            ...
            function a(b, c, d, e, f, g) {
              var h = {
                  comment_embed: { href: "url", include_parent: "bool" },
                  composer: {
                    action_type: "string",
                  ...
                  page_events: { href: "url" },
                  post: { href: "url", show_text: "bool" },
                  profile_pic: {
                    uid: "string",
                    linked: "bool",
                    href: "string",
          ...
          __d(
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m) {
              ...
              function t(y) {
                return (
                  n[r(y, "nodeName").toLowerCase()] || n[s(y).toLowerCase()]
                );
              }
              function u(y) {
                var z = ES(
                  r(y, "className").split(/\s+/),
                  "filter",
                  true,
                  function(aa) {
                    return Object.prototype.hasOwnProperty.call(o, aa);
                  }
                );
                if (z.length === 0) return undefined;
                if (
                  y.getAttribute("fb-xfbml-state") ||
                  !y.childNodes ||
                  y.childNodes.length === 0 ||
                  (y.childNodes.length === 1 &&
                    y.childNodes[0].nodeType === 3) ||
                  (y.children.length === 1 &&
                    r(y.children[0], "className") === "fb-xfbml-parse-ignore")
                )
                  return o[z[0]];
              }
              function v(y) {
                var z = {};
                ES(
                  ES("Array", "from", false, y.attributes),
                  "forEach",
                  true,
                  function(aa) {
              ...
              function w(y, z, aa) {
                ...
                i.addCss(y, z + "-" + aa);
                ES(
                  ES("Array", "from", false, y.childNodes),
                  "forEach",
                  true,
                  function(ca) {
                    ba.appendChild(ca);
              ...
              function x(y, z, aa) {
                ...
                ES(
                  ES("Array", "from", false, y.getElementsByTagName("*")),
                  "forEach",
                  true,
                  function(ga) {
            ...
            function a(
              ...
              var u = m.extend({
                  ...
                  process: function w(x) {
                    ...
                    this._done = true;
                    this._iframeName =
                      this.getIframeName() || this._iframeName || n();
                    ...
                    if (this._visibleAfter != "immediate") {
                      ...
                      this.subscribe(
                        "iframe.onload",
                        ES(this.fire, "bind", true, this, "render")
                      );
                    var y = this.getSize() || {},
                  ...
                  _oneTimeSetup: function w() {
                    this.subscribe(
                      "xd.resize",
                      ES(this._handleResizeMsg, "bind", true, this)
                    );
                    this.subscribe(
                      "xd.resize",
                      ES(this._bubbleResizeEvent, "bind", true, this)
                    );
                    this.subscribe(
                      "xd.resize.iframe",
                      ES(this._resizeIframe, "bind", true, this)
                    );
                    this.subscribe(
                      "xd.resize.flow",
                      ES(this._resizeFlow, "bind", true, this)
                    );
                    this.subscribe(
                      "xd.resize.flow",
                      ES(this._bubbleResizeEvent, "bind", true, this)
                    ...
                    if (this._visibleAfter == "load")
                      this.subscribe(
                        "iframe.onload",
                        ES(this._makeVisible, "bind", true, this)
                      );
                    this.subscribe(
                      "xd.verify",
                      ES(
                  ...
                  _repositionIframe: function w(x) {
                    var y = this.getIframeNode(),
                      ...
                      aa = k.getPosition(y).x,
                      ba = k.getViewportInfo().width,
                      ca = parseInt(x.width, 10);
                    if (aa + ca > ba && aa > ca) {
                  ...
                  _getURL: function w() {
                    var x = this.getDefaultWebDomain(),
                      y = "";
                    return (
                      x + "/plugins/" + y + this.getUrlBits().name + ".php"
                    );
                  },
              ...
              var o = 320,
                p = i.extend({
                  ...
                  setupAndValidate: function q() {
                    ...
                    if (
                      l.initSitevars.enableMobileComments &&
                      m.mobile() &&
                      r.mobile !== false
                    ) {
                      r.mobile = true;
                    ...
                    if (!r.href) {
                      ...
                      if (!r.xid) {
                        ...
                        if (s > 0) {
                          r.xid = encodeURIComponent(
                            document.URL.substring(0, s)
                          );
                      ...
                      if (!t) {
                        ...
                        if (t && ES(t, "indexOf", true, "#") > 0)
                          t = t.substring(0, ES(t, "indexOf", true, "#"));
                      }
                      if (t) {
                        r.fb_comment_id = t;
                        this.subscribe(
          ...
          __d(
            ...
            ["ApiClient", "sdk.DOM", "sdk.XFBML.Element", "sprintf"],
            function a(b, c, d, e, f, g, h, i, j, k) {
              var l = j.extend({
                process: function m() {
                  ...
                  h.scheduleBatchCall(
                    ...
                    ES(
                      function(o) {
                        ...
                        i.html(
                          this.dom,
                          k('<span class="fb_comments_count">%s</span>', p)
                        );
                        if (p > 0)
          ...
          __d(
            "sdk.Helper",
            ["sdk.ErrorHandling", "sdk.Event", "UrlMap", "safeEval", "sprintf"],
            function a(b, c, d, e, f, g, h, i, j, k, l) {
              var m = {
                isUser: function n(o) {
                  return (
                    o < 2.2e9 ||
                    (o >= 1e14 && o <= 100099999989999) ||
                    (o >= 8.9e13 && o <= 89999999999999) ||
                    (o >= 6.000001e13 && o <= 60000019999999)
                  );
                },
          ...
          __d(
            ...
            ["sdk.Helper", "IframePlugin", "Log", "sdk.ui", "sdk.XD"],
            function a(b, c, d, e, f, g, h, i, j, k, l) {
              var m = i.extend({
                    ...
                    t = function v(w) {
                      if (w.error_code) {
                        j.debug(
                          ...
                          w.error_code,
                          w.error_message || w.error_description
                        );
                        return;
                      }
              ...
              var o = {}.hasOwnProperty,
                p = k.extend({
                  ...
                  _renderOther: function q(r) {
                    ...
                    if (!s)
                      s = i(this.getAttribute("if-cant-see", "Facebook User"));
                    if (s) {
                      if (this._getBoolAttribute("capitalize", false))
                        s = l.upperCaseFirstChar(s);
                      if (r && this._linked) {
              ...
              var ca = j.extend({
                constructor: function da(ea, fa, ga, ha) {
                  ...
                  u = ES(
                    ...
                    function(ia) {
                      return (
                        ia.nodeName.toLowerCase() === "article" ||
                        h.containsCss(ia, p)
                      );
                    }
                  );
                    ...
                    this.subscribe(
                      ...
                      ES(
                        function(y) {
                          ...
                          aa = this.setupNewIframeDialog(
                            ES("JSON", "parse", false, y.data),
                            y.fromIframe,
                            ES("JSON", "parse", false, y.isHTTPS)
                          );
                          da(aa);
                          h.append(aa);
                          ba = [aa, z];
                          ...
                          this.subscribe(
                            ...
                            ES(
                              function() {
                                ...
                                if (!x && !fa)
                                  fa = i.addIdleDesktopAction(aa, ea, 7000);
                              },
                              "bind",
                              true,
                              this
              ...
              var o = j.extend({
                constructor: function p(q, r, s, t) {
                  ...
                  this.subscribe("xd.onVideoAPIReady", function(u) {
                    ...
                    this._sharedVideoCache = new m(
                      ES("JSON", "parse", false, u.data)
                    );
                    this._videoController = new n(
          ...
          __d(
            ...
            function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
              ...
              ES(ES("Object", "keys", false, m), "forEach", true, function(t) {
                if (ES(s, "indexOf", true, t) !== -1) return;
                n.registerTag({
                  xmlns: "fb",
                  localName: t.replace(/_/g, "-"),
                  ctor: k.withParams(m[t], l[t])
                });
              });
              ES(ES("Object", "keys", false, r), "forEach", true, function(t) {
                if (ES(s, "indexOf", true, t) !== -1) return;
                n.registerTag({
                  xmlns: "fb",
                  localName: t.replace(/_/g, "-"),
              ...
              n.subscribe(
                "render",
                ES(i.fire, "bind", true, i, "xfbml.render")
              );
              i.subscribe("init:post", function(t) {
                if (t.xfbml)
                  setTimeout(
                    q(
                      ES(o, "bind", true, null, n.parse),
                      "entry",
              ...
              h.define("Xfbml", function(t) {
                return (
                  (t.nodeType === 1 || t.nodeType === 9) &&
  ...
  new Image().src =
    ...
    encodeURIComponent(
      '{"error":"LOAD", "extra": {"name":"' +
        ...
        '","revision":"3240711","namespace":"FB","message":"' +
        e.message +
        '"}}'
    );
}
